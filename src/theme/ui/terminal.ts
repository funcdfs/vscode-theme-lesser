...
export const terminal = {
  ...
  "terminalOverviewRuler.findMatchForeground": withOpacity(palette.sapphire, "muted"),
...
export const terminalAnsi = {
  ...
  "terminal.ansiRed": palette.maroon,
