export const lesserTheme = {
  ...
  colors: {
    ...
    'editor.inactiveSelectionBackground': '#be84bf25',
    ...
    'editorSuggestWidget.selectedBackground': '#2a2530',
